...
System.out.println("Welcome to Deadwood. The game of all games");
    ...
    roll_call(boardloc, playersReal[j], board);
    //role been called
    }
    }else {
    ...
    //work function
    working(boardloc, playersReal[j], current_location, board, scene_count, playersReal);  
    //work function end    
    }else {
...
//loop to make sure you take a valid role: doesnt work correct so need to modify
...
System.out.println("You did not take a role.");
  ...
  //function for work
  public static void working(Board boardloc, Player player_name,
 String current_location, HashMap<Location, Scene> board, int scene_count, Player[] players ) {
...
//work add to function:
//act or rehearse section
